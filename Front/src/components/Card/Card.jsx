...
function Card({name, id, image, gender, specie, addFavorites, removeFavorites, myFavorites, onClose}) {
 ...
 // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    <div className={c.containerTwo}>
      {
   isFav ? (<button className={c.buttonFav} onClick={handleFavorite}>♕</button>) : (<button  className={c.buttonFav} onClick={handleFavorite}>🤍</button>)
      }
